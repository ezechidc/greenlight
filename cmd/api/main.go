...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "483b86edfd40aa", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "a8495eecefc85c", "SMTP password")
